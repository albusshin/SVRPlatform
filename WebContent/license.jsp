...
<body>
    ...
    <br>
    <br>
    <div class="commentstitle">The SVRPlatform uses Apache License, Version 2.0</div>
    <p><br>
      <br>
...
<p>TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION</p>
	...
	<br>
    <p><strong><a name="copyright">2. Grant of Copyright License</a></strong>.<br>
	Subject to the
	...
	<br>
    <p><strong><a name="patent">3. Grant of Patent License</a></strong>.<br>
	...
	<br>
    <p><strong><a name="redistribution">4. Redistribution</a></strong>.<br>
	...
	<br> This License does not grant
    ...
    <br>
    <div class="highlite">
    Copyright © 2012 www.SVRPlatform.com<br><br>
