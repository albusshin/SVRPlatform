...
<body>
    ...
    <div id="contains">
        ...
        <div id="buttons">
            <a href=/SVRPlatform/SigningUp style="border-bottom:none"><img class="button"  onmouseover="this.src='images/registerbuttonpressed.png'" onmouseout="this.src='images/registerbutton.png' "src="images/registerbutton.png" width="240"/></a>
            <a href=/SVRPlatform/SigningIn style="border-bottom:none"><img class="button"  onmouseover="this.src='images/loginbuttonpressed.png'" onmouseout="this.src='images/loginbutton.png'"  src="images/loginbutton.png" width="240"/></a>
		</div>
    </div>
